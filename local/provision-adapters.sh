...
else (cd /vagrant/apps/daylist-adapter/ && bundle install && torquebox deploy && echo "- - - Successfully setup Daylist Adapter - - -") || echo "- - - Can't install daylist adapter off-DITI - --"
fi
...
else (cd /vagrant/apps/titles-adapter/ && bundle install && torquebox deploy && echo "- - - Successfully setup Titles Adapter - - -") || echo "- - - Can't install titles adapter off-DITI - --"
fi